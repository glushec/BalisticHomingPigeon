...
def main():
    ...
    showStartScreen()
    while True:
        # inicijalizacija na pocetnoto vreme
...
def runGame():
    ...
    # brojaci za izedeni jabolka
    eaten_pink_num = 0
    eaten_yellow_num = 0
    eaten_red_num = 0

    # koordinati za site elementi
    ...
    while True:  # main game loop
        ...
        # vkajanje na vkupniot broj jabolka izedeni dololku igacot izleze od grid
        if (
            wormCoords[HEAD]["x"] == -1
        ...
        # proverka dali postoi vtor crv
        has_eaten = False
        if is_spawned():
            # menuvanje na nasokata na dvizenje na vtoriot crv
            ...
            # proverka dali prviot crv e izeden od drugiot crv
            has_eaten = False
            ...
            # proverka dali vtoriot crv e izeden od prviot crv
            has_eaten = False
...
# promeni vo funkcijata za da moze da se prikazat i drigi elementi
...
# generianje koordinati za novi elementi
...
# proverka dali se pominati 20 sekundi od startot
def is_spawned():
    return time.time() - START_TIME >= 20

# funkcija za generiranje nova nasoka na vtoriot crv
