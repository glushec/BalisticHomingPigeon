...
public class HomingMissile : MonoBehaviour 
{
        ...
        [HideInInspector] private Rigidbody target;
        ...
        private void FixedUpdate() {
            ...
            var leadTimePercentage = Mathf.InverseLerp(minDistancePredict, maxDistancePredict, Vector3.Distance(transform.position, targetObject.transform.position));
